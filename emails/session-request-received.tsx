...
type SessionRequestReceivedEmailProps = {
...
export function SessionRequestReceivedEmail({
  ...
  trainingType,
  sessionsUrl,
}: SessionRequestReceivedEmailProps) {
  return (
    <Html>
      <Head />
      <Preview>Nouvelle demande · Session de {trainingType}</Preview>
      <Body style={styles.body}>
        <Container style={styles.card}>
          <Text style={styles.brand}>Sparrtners</Text>
          <Heading style={styles.title}>Session de {trainingType}</Heading>
          <Text style={styles.text}>
            {requesterName} a demandé à rejoindre ta session.
          </Text>
          ...
          <Text style={styles.helper}>
            Ouvre l’app pour accepter ou refuser la demande.
          </Text>
        </Container>
      </Body>
    </Html>
