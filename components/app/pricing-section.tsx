...
export async function PricingSection({
  ...
  const rightOrder = checkoutFirstOnMobile ? 'order-1 md:order-2' : '';

  return (
    <div className={`grid gap-8 md:grid-cols-[1.1fr_1fr] ${className}`.trim()}>
      <section className={leftOrder}>
